# LEGALS — prize_draw
*Mined from terms.py. Client chooses, never writes. Land verbatim. Suze signs off. Every date is computed, never generated.*

## Facts the clauses fill from (needs.md → facts)
